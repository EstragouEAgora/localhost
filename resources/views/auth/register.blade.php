            ...
            <div class="container">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <input id="telefone" type="text" class="telmask telefone form-control @error('telefone') is-invalid @enderror" name="telefone"
                    ...
                    <div class="row mb-3">
                        <label for="password" class="col-md-4 col-form-label text-md-end">
                            ...
                            <span class="label-text">Senha (mínimo 6 caracteres)</span>
                        </label>
                        <div class="col-md-4">
                            <input id="password" type="password"
                                class="form-control @error('password') is-invalid @enderror" name="password" required
                                autocomplete="new-password" placeholder="Senha (mínimo 6 caracteres)">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <select name="tipo" require="required" style="width:'50%'; border-radius: 5px;"
                                id="tipo"class="@error('tipo') is-invalid @enderror">
