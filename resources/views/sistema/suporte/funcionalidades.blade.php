<!-- Página que tem como objetivo demonstrar as funcionalidades do sistema -->    
...
<div class="container" style="margin-top: 150px">
    ...
    <p id="subtitulo-da-pagina"><b>O "Estragou e Agora?" oferece uma variedade de funcionalidades para facilitar o
            contato entre clientes e prestadores de serviços. Aqui estão as três principais funcionalidades do nosso
            site:</b></p>
    ...
    <p id="func-topicos"><b>3. Gerenciamento de pedidos:</b> Os clientes têm uma área onde gerenciam seus pedidos,
