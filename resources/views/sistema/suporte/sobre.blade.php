...
@section('content')
    <div class="container">
        ...
        <p id="func-topicos">Nós somos um grupo de estudantes do CEFET-MG, localizado em Varginha, e estamos animados para
            ...
            Explore nosso site, conheça nossos prestadores de serviços e aproveite a praticidade de ter todas as soluções ao
            seu alcance. Estamos ansiosos para ajudar você a superar qualquer obstáculo e transformar o "Estragou e Agora?"
            em "Resolvido e Pronto!". </p>
